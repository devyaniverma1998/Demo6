                    ...
                    <div id="product-carousel" className="carousel slide" data-ride="carousel">
                        <div className="carousel-inner bg-light">
                            <div className="carousel-item active">
                                <img className="w-100 h-100" src="/img/product-1.jpg" alt="not found" />
                            </div>
                            <div className="carousel-item">
                                <img className="w-100 h-100" src="/img/product-2.jpg" alt="not found" />
                            </div>
                            <div className="carousel-item">
                                <img className="w-100 h-100" src="/img/product-3.jpg" alt="not found" />
                            </div>
                            <div className="carousel-item">
                                <img className="w-100 h-100" src="/img/product-4.jpg" alt="not found" />
                            </div>
                        </div>
