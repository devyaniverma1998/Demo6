        ...
        <div className="col-lg-8 table-responsive mb-5">
            <table className="table table-light table-borderless table-hover text-center mb-0">
                ...
                <tbody className="align-middle">
                    <tr>
                        <td className="align-middle"><img src="/img/product-1.jpg" alt="not found" / > Product Name</td>
                    ...
                    <tr>
                        <td className="align-middle"><img src="/img/product-2.jpg" alt="not found" / > Product Name</td>
                        <td className="align-middle">$150</td>
                        <td className="align-middle">
                            <div className="input-group quantity mx-auto" >
                                <div className="input-group-btn">
                    ...
                    <tr>
                        <td className="align-middle"><img src="/img/product-3.jpg" alt="not found" /> Product Name</td>
                        <td className="align-middle">$150</td>
                        <td className="align-middle">
                            <div className="input-group quantity mx-auto" >
                                <div className="input-group-btn">
                    ...
                    <tr>
                        <td className="align-middle"><img src="/img/product-4.jpg" alt="not found" / > Product Name</td>
                        <td className="align-middle">$150</td>
                        <td className="align-middle">
                            <div className="input-group quantity mx-auto" >
                                <div className="input-group-btn">
                    ...
                    <tr>
                        <td className="align-middle"><img src="/img/product-5.jpg" alt="not found" / > Product Name</td>
                        <td className="align-middle">$150</td>
                        <td className="align-middle">
                            <div className="input-group quantity mx-auto" >
                                <div className="input-group-btn">
